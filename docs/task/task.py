...
def main(dataset):
    ...
    for i in rdataset:
      ...
      for index,value in enumerate(i):
         lie.append([index,value])
      include.append(lie)
    include2=[]   
    print(include[0])
    for i in itertools.combinations(include[0], dataset[1]):
           print(i)

    for ii in include:
       for i in itertools.combinations(ii, dataset[1]):
           include2.append(i)
    return include2
...
#                 #  sub2=index[1][0]
#                 #  sub1.append(sub2)
#                 #  posi=possibly[sub1[0]]
#                 #  for ind,indx in enumerate(sub1):
#                 #        posi=np.intersect1d(possibly[indx], posi)
#                 #  sothat.append([sub1,posi])
#                  sub1=index[0]
#                  for p2 in index[1]:
#                      su=sub1.copy()
#                      su.append(p2)
